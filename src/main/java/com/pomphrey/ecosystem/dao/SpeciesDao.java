...
public class SpeciesDao {
    ...
    public void insertSpecies(Species species){
        ...
        params.put("mature_age", Integer.toString(species.getMature_age()));
        params.put("senile_age", Integer.toString(species.getSenile_age()));
        ...
        String query = "insert into species values (:name, :type, :mature_age, :senile_age, " +
